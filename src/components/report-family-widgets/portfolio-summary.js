            ...
            <ul className="nav mb-3" id="pills-tab" role="tablist">
              ...
              <li>
                <div className="dropdown">
                  <NavLink className="dropdown-toggle" to="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">Today</NavLink>
                  <ul className="dropdown-menu">
                    <li><NavLink className="dropdown-item" to="#">1 Month</NavLink></li>
                    <li><NavLink className="dropdown-item" to="#">1 Year</NavLink></li>
                    <li><NavLink className="dropdown-item" to="#">All Time</NavLink></li>
                  </ul>
                </div>
              </li>
            </ul>
