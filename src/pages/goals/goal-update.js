...
const CreateGoal = () => {
  ...
  const [option, setOption] = useState(Location.state.goal)
  ...
  const [dataList, setDataList] = useState({ ...Location.state })
  ...
  const handalSubmit = async event => {
    ...
    await axios.post(`https://urlsdemo.xyz/tradeweb/api/risk-update/${Location.state.risk_key}`, datalist);
    Navigate('/goals')
  }
                    ...
                    <div className='form-check'>
                      <div>
                        <input
                          ...
                          checked={savingOption.BankOption?true:false}
                      ...
                      {savingOption.BankOption && <div className='bankValue'>
                        <input name="bank_option_value" onChange={hadalChange} value={dataList.bank_option_value} placeholder='0' type="number" className='rangeInput' />INR</div>}
                    </div>
                    <div className='form-check'>
                      <div>
                        <input
                          ...
                          name='EstateOption'
                          onChange={hadalCheckBox}
                          checked={savingOption.EstateOption?true:false}
                          value='Real Estate'
                        />
                      ...
                      {savingOption.EstateOption && <div className='bankValue'>
                        <input name="estate_option_value" onChange={hadalChange} value={dataList.estate_option_value} placeholder='0' type="number" className='rangeInput' />INR</div>}
                    </div>
                    <div className='form-check'>
                      <div>
                        <input
                          ...
                          checked={savingOption.GoldOption?true:false}
                        />
                        <label className='form-check-label' htmlFor='check3'>
                          Gold and other ornaments
                        </label>
                      </div>
                      {savingOption.GoldOption && <div className='bankValue'>
                        <input name="gold_option_value" onChange={hadalChange} value={dataList.gold_option_value} placeholder='0' type="number" className='rangeInput' />INR</div>}
                    </div>
                    <div className='form-check'>
                      <div>
                        <input
                          ...
                          onChange={hadalCheckBox}
                          value='Insurance'
                          checked={savingOption.InsuranceOption?true:false}
                        />
                        <label className='form-check-label' htmlFor='check4'>
                          Insurance
                        </label>
                      </div>
                      {savingOption.InsuranceOption && <div className='bankValue'>
                        <input value={dataList.insurance_option_value} name="insurance_option_value" onChange={hadalChange} placeholder='0' type="number" className='rangeInput' />INR</div>}
                    </div>
                    <div className='form-check'>
                      <div>
                        <input
                          ...
                          onChange={hadalCheckBox}
                          value='Pension Fund'
                          checked={savingOption.Pension_Fund?true:false}
                        />
                        <label className='form-check-label' htmlFor='check5'>
                          Pension Fund
                        </label>
                      </div>
                      {savingOption.Pension_Fund && <div className='bankValue'>
                        <input name="pension_fund_value" onChange={hadalChange} value={dataList.pension_fund_value} placeholder='0' type="number" className='rangeInput' />INR</div>}
                    </div>
                    <div className='form-check'>
                      <div>
                        <input
                          ...
                          id='check6'
                          name='Others_option'
                          checked={savingOption.Others_option?true:false}
                          onChange={hadalCheckBox}
                          value='Others'
                        />
                      ...
                      {savingOption.Others_option && <div className='bankValue'>
                        <input name="others_option_value" onChange={hadalChange} placeholder='0' value={dataList.others_option_value} type="number" className='rangeInput' />INR</div>}
                    </div>
                  </div>
                  <div className='cg-input-box'>
